...
for (let i = 0; i < rows.length; i++) {
  ...
  if (i === 0) {
    ...
    label = '個店メルマガ';
  } else if (name === 'Gold特典メール') {
    label = '会員特典';
  } else if (name.includes('THANKS招待')) {
    label = 'THANKS招待';
  } else if (name.includes('全店メルマガ') || name.includes('週間ランキング') || name.includes('レコメンド')) {
    label = '全体メルマガ';
  } else if (name.includes('クーポンメール')) {
    label = 'クーポンメール';
  } else if (name.includes('INFO')) {
    label = 'INFO';
  } else if (name.includes('RNオープン')) {
    label = 'RNオープン';
  } else if (name.includes('mobility')) {
    label = 'mobility';
  } else if (name.includes('BAY閉店') || name.includes('閉店')) {
    label = '閉店メルマガ';
  } else {
    label = '全体メルマガ';
  }
